...
from inventario.forms import RepuestoForm
import pandas as pd
...
from inventario.models import Repuesto, RepuestoAplicacion, RepuestoEnStock, StockMovimiento, RepuestoExterno
from core.models import Cliente_Taller, Vehiculo, Componente, Accion, ComponenteAccion, VehiculoVersion
from diagnosticos.models import Diagnostico, DiagnosticoComponenteAccion, DiagnosticoRepuesto
from trabajos.models import Trabajo, TrabajoFoto, TrabajoRepuesto, TrabajoAccion
from usuarios.models import Mecanico
from punto_venta.models import VentaPOS, SesionVenta, CarritoItem
from configuracion.models import AdministracionTaller
from django.contrib.auth.models import User
from django.forms import modelformset_factory
from django.forms import inlineformset_factory
from core.utils_auditoria import (
...
from core.forms import ComponenteForm, ClienteTallerForm, ClienteTallerRapidoForm, VehiculoForm, AccionForm, ComponenteAccionForm
from diagnosticos.forms import DiagnosticoForm
from trabajos.forms import AsignarMecanicosForm, SubirFotoForm
from inventario.forms import RepuestoForm
from configuracion.forms import AdministracionTallerForm
...
def login_view(request):
    ...
    return render(request, "usuarios/login.html", {"form": form, "config": config})
...
def componente_list(request):
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest':
        html = render_to_string('core/componentes_tree.html', {'componentes': componentes, 'config': config})
...
def ingreso_view(request):
    ...
    if resolver_name == 'ingreso_voz':
        template_name = 'inventario/ingreso_movil_voz.html'
    elif (
        is_mobile or
        request.GET.get('layout') == 'fusionado' or
        resolver_name == 'ingreso_rapido'
    ):
        template_name = 'inventario/ingreso_fusionado.html'
    else:
        template_name = 'inventario/ingreso-pc.html'
...
def ingreso_exitoso_view(request):
    ...
    return render(request, 'inventario/ingreso_exitoso.html', {'config': config})
...
def editar_diagnostico(request, pk):
    ...
    return render(request, 'inventario/editar_diagnostico.html', {'form': diagnostico_form, 'config': config})
...
def componente_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('componente_list')
    return render(request, 'core/componentes_confirm_delete.html', {
...
def mostrar_plano(request):
    ...
    return render(request, 'inventario/plano_interactivo.html', {'svg': svg_content, 'config': config})
...
def lista_diagnosticos(request):
    ...
    return render(request, 'diagnosticos/diagnostico_lista.html', {
...
def editar_diagnostico(request, pk):
    ...
    return render(request, 'diagnosticos/diagnostico_editar.html', context)
...
def eliminar_diagnostico(request, pk):
    ...
    return render(request, 'diagnosticos/diagnostico_eliminar.html', {'diagnostico': diagnostico, 'config': config})
...
def accion_list(request):
    ...
    return render(request, 'core/accion_list.html', {"acciones": acciones, "q": q, "config": config})
...
def accion_create(request):
    ...
    return render(request, 'core/accion_form.html', {"form": form, "modo": "crear", "config": config})
...
def accion_update(request, pk):
    ...
    return render(request, 'core/accion_form.html', {"form": form, "modo": "editar", "accion": accion, "config": config})
...
def accion_delete(request, pk):
    ...
    return render(request, 'core/accion_confirm_delete.html', {"accion": accion, "config": config})
...
def comp_accion_list(request):
    ...
    return render(request, 'core/comp_accion_list.html', {"items": items, "q": q, "config": config})
...
def comp_accion_create(request):
    ...
    return render(request, 'core/comp_accion_form.html', {"form": form, "modo": "crear", "config": config})
...
def comp_accion_update(request, pk):
    ...
    return render(request, 'core/comp_accion_form.html', {"form": form, "modo": "editar", "obj": obj, "config": config})
...
def comp_accion_delete(request, pk):
    ...
    return render(request, 'core/comp_accion_confirm_delete.html', {"obj": obj, "config": config})
...
def exportar_diagnostico_pdf(request, pk):
    ...
    try:
        ...
        template = get_template('diagnosticos/diagnostico_pdf.html')
...
class MecanicoListView(ListView):
    model = Mecanico
    template_name = 'usuarios/mecanico_list.html'
...
class MecanicoCreateView(CreateView):
    ...
    template_name = 'usuarios/mecanico_form.html'
...
class MecanicoDeleteView(DeleteView):
    model = Mecanico
    template_name = 'usuarios/mecanico_confirm_delete.html'
    success_url = reverse_lazy('mecanico_list')
...
def lista_trabajos2(request):
    ...
    return render(request, 'trabajos/trabajo_lista.html', {
        'trabajos': trabajos
    })
...
def historial_trabajos(request):
    ...
    return render(request, 'trabajos/trabajo_historial.html', {
        'trabajos': trabajos,
        'config': config
    })
...
def trabajo_detalle(request, pk):
    ...
    if is_mobile_device(request):
        template_name = 'trabajos/trabajo_detalle_movil.html'
    else:
        template_name = 'trabajos/trabajo_detalle_nuevo.html'
...
def trabajo_pdf(request, pk):
    ...
    try:
        ...
        # Template para el PDF
        template = get_template('trabajos/trabajo_pdf.html')
        logger.info("✅ Template cargado correctamente")
...
def pizarra_view(request):
    ...
    return render(request, 'inventario/pizarra_page.html', context)
...
def panel_principal(request):
    ...
    return render(request, 'inventario/panel_definitivo.html', context)
...
def venta_crear(request):
    ...
    return render(request, "punto_venta/venta_crear.html", context)
...
def venta_detalle(request, pk):
    ...
    return render(request, "punto_venta/venta_detalle.html", {"venta": venta})


def ventas_historial(request):
    ventas = Venta.objects.all().order_by("-fecha")
    return render(request, "punto_venta/ventas_historial.html", {"ventas": ventas})
...
def tracking_publico(request):
    ...
    return render(request, 'inventario/tracking_publico.html', {"placa": placa, "trabajo": trabajo})
...
def tracking_publico_preview(request):
    ...
    html = render_to_string('trabajos/_tracking_card.html', {"trabajo": trabajo}, request=request)
...
def administracion_taller(request):
    ...
    return render(request, 'configuracion/administracion_taller.html', context)
...
class ClienteTallerListView(ListView):
    ...
    template_name = 'core/cliente_taller_list.html'
...
class ClienteTallerCreateView(CreateView):
    ...
    template_name = 'core/cliente_taller_form.html'
...
class ClienteTallerDeleteView(DeleteView):
    ...
    model = Cliente_Taller
    template_name = 'core/cliente_taller_confirm_delete.html'
    success_url = reverse_lazy('cliente_taller_list')
...
def selector_test_view(request):
    ...
    return render(request, 'inventario/selector_test.html', {'clientes': clientes})
...
def repuesto_compatibilidad(request, pk):
    ...
    return render(request, 'inventario/repuesto_compatibilidad.html', context)
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if not nombre:
                ...
                return render(request, 'inventario/agregar_repuesto_externo_rapido.html', {'datos': datos_bookmarklet})
...
def bookmarklet_info(request):
    ...
    """
    return render(request, 'inventario/bookmarklet_repuestos.html')

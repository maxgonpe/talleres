...
MIDDLEWARE = [
    ...
    'car.middleware.PermisosMiddleware',  # NUEVO: Middleware de permisos
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'car.context_processors.configuracion_taller',
            ],
        },
    },
]
...
MEDIA_ROOT = BASE_DIR / 'media'  # Ruta en el sistema de archivos

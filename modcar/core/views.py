...
from inventario.models import Repuesto, RepuestoAplicacion, RepuestoEnStock, StockMovimiento
...
def panel_principal(request):
    ...
    return render(request, "core/panel_definitivo.html", context)
...
def selector_test_view(request):
    ...
    return render(request, 'core/selector_test.html', {'clientes': clientes})

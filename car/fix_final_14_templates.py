#!/usr/bin/env python3
"""
Script final definitivo para corregir los 14 templates restantes
"""
...
def fix_final_template(file_path):
    """Corrige definitivamente un template"""
    try:
        ...
        # 1. Forzar centralized-colors.css SIEMPRE
        ...
        bootstrap_fixes = {
            ...
            r'class="text-end"': 'class="text-end"',  # Mantener
        ...
        inline_fixes = {
            ...
            r'style="cursor:pointer; padding: var\(--spacing-xs\)[^"]*"': 'style="cursor: pointer; padding: var(--spacing-xs);"',
        }
...
def main():
    ...
    print("🔧 CORRECCIÓN FINAL DEFINITIVA DE LOS 14 TEMPLATES RESTANTES")
    print("=" * 70)
    
    # Lista de los 14 templates que necesitan corrección
    final_templates = [
    ...
    for template_path in final_templates:
    ...
    print("✅ Corrección final definitiva completada!")

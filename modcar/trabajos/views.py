...
def ingreso_view(request):
    ...
    if resolver_name == 'ingreso_voz':
        template_name = 'diagnosticos/ingreso_movil_voz.html'
    elif (
        is_mobile or
        request.GET.get('layout') == 'fusionado' or
        resolver_name == 'ingreso_rapido'
    ):
        template_name = 'diagnosticos/ingreso_fusionado.html'
    else:
        template_name = 'diagnosticos/ingreso-pc.html'
...
def ingreso_exitoso_view(request):
    ...
    return render(request, 'diagnosticos/ingreso_exitoso.html', {'config': config})
...
def editar_diagnostico(request, pk):
    ...
    return render(request, 'diagnosticos/editar_diagnostico.html', {'form': diagnostico_form, 'config': config})
...
def mostrar_plano(request):
    ...
    return render(request, 'core/plano_interactivo.html', {'svg': svg_content, 'config': config})
...
def pizarra_view(request):
    ...
    return render(request, 'trabajos/pizarra_page.html', context)
...
def panel_principal(request):
    ...
    return render(request, 'trabajos/panel_definitivo.html', context)
...
def tracking_publico(request):
    ...
    return render(request, 'trabajos/tracking_publico.html', {"placa": placa, "trabajo": trabajo})
...
def selector_test_view(request):
    ...
    return render(request, 'trabajos/selector_test.html', {'clientes': clientes})
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if not nombre:
                ...
                return render(request, 'trabajos/agregar_repuesto_externo_rapido.html', {'datos': datos_bookmarklet})
...
def bookmarklet_info(request):
    ...
    """
    return render(request, 'trabajos/bookmarklet_repuestos.html')

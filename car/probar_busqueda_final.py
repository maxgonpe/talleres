#!/usr/bin/env python3
"""
Script final para probar la búsqueda de repuestos en compras
"""
...
def probar_busqueda_final():
    print("🔍 PROBANDO BÚSQUEDA FINAL EN COMPRAS")
    print("=" * 60)
    ...
    try:
        # 1. BUSCAR ACEITE 10W-40 CON FILTROS SIMPLIFICADOS
        print("📊 BUSCANDO ACEITE 10W-40 CON FILTROS SIMPLIFICADOS...")
        query = "Aceite 10w-40"
        ...
        if not repuestos:
            print("❌ No se encontraron repuestos con filtros simplificados")
            return
        ...
        print("\n🎯 RESUMEN DE LA BÚSQUEDA FINAL EN COMPRAS:")

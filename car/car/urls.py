...
urlpatterns = [
    ...
    path("api/repuesto-compatibilidad/<int:repuesto_id>/", views.repuesto_compatibilidad_api, name="repuesto_compatibilidad_api"),
    path("compras/<int:pk>/items-ajax/", views_compras.compra_items_ajax, name="compra_items_ajax"),
